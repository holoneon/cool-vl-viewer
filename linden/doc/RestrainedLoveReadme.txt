...
- Get the Cool VL Viewer from http://sldev.free.fr/
...
2.09.29.30 (@versionnum = 2092930) by Henri Beauchamp:
- Added: user.name censoring for @shownames, to cope with scripts printing them (the user name is never used/shown by the Cool VL Viewer itself).


2.09.29.29 (@versionnum = 2092929) by Henri Beauchamp:
- Fixed: non-working @camtextures in ALM/forward mode, and a crash with it in PBR mode.
