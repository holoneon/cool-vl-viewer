...
public:
	...
	LL_INLINE bool isTransparent() const			{ return mColor.mV[VALPHA] < 0.001f; }
	LL_INLINE bool isOpaque() const					{ return mColor.mV[VALPHA] >= 0.999f; }
