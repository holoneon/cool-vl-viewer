...
public:
	...
	enum EFlags : U8
	{
		...
		FLAG_MIRROR		= 0x04,	// Probe used for real time mirrors.
	};
	...
	LL_INLINE void setIsMirror(bool is_mirror)
	{
		if (is_mirror)
		{
			mFlags |= FLAG_MIRROR;
	...
	LL_INLINE bool getIsMirror() const
	{
		return (mFlags & FLAG_MIRROR) != 0;
	}
