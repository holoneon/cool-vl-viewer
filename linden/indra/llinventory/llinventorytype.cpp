...
#if LL_MESH_ASSET_SUPPORT
	addEntry(LLInventoryType::IT_GLTF,			new InventoryEntry("gltf",		"gltf json",		1, LLAssetType::AT_GLTF));
	addEntry(LLInventoryType::IT_GLTF_BIN,		new InventoryEntry("gltfbin",	"gltf binary",		1, LLAssetType::AT_GLTF_BIN));
#endif
}
