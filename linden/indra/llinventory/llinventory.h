...
public:
	...
	LL_INLINE bool getIsLinkType() const
	{
...
public:
	...
	LL_INLINE virtual const LLUUID& getCreatorUUID() const
	{
	...
	LL_INLINE const std::string& getTargetLanguage() const
	{
	...
	LL_INLINE void setAssetUUID(const LLUUID& id)			{ mAssetUUID = id; }
	...
	LL_INLINE void setCreator(const LLUUID& creator)
	{
