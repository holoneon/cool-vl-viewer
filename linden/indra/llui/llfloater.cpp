		...
		mResizeHandle[1] =
			new LLResizeHandle("resize",
							   LLRect(getRect().getWidth() -
									  ...
									  RESIZE_HANDLE_HEIGHT),
							   min_width, min_height,
							   LLResizeHandle::RIGHT_TOP, !close_btn);
...
//virtual
const std::string& LLMultiFloater::getTag() const
{
								...
								LLTabContainer::eInsertionPoint insertion_pt)
{
	...
	mTabContainer->addTabPanel(floaterp, floaterp->getTitle(), false,
...
//virtual
const std::string& LLFloater::getTag() const
{
