...
public:
	...
	LL_INLINE void setFont(const LLFontGL* fontp)	{ mFontGL = fontp; }
	LL_INLINE const LLFontGL* getFont() const		{ return mFontGL; }
	LL_INLINE LLFontVertexBuffer& getFontVB() 		{ return mFontVB; }
...
public:
	...
	// Shapes this menu to fit the current state of the children, and adjusts
	// the child rects to fit. This is called automatically when you add items.
	// *FIXME: we may need to deal with visibility arrangement.
...
extern const std::string LL_PIE_MENU_TAG;
