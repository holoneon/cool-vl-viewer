	...
	mCallbackUserData(NULL)
{
	...
	mThresholdColors[2] = LLColor4(1.f, 0.6f, 0.f, 1.f);
	mThresholdColors[3] = LLColor4(1.f, 0.f, 0.f, 1.f);
	mThresholdColors[4] = LLColor4(0.75f, 0.75f, 0.75f, 1.f);
...
void LLStatGraph::draw()
{
	...
	// Note: we want to draw a full bar (with the special mThresholdColors[4]
