...
// Returned when we do not know what to do with the mime type
std::string sDefaultLabel;
// Returned when we do not know what widget set to use
std::string sDefaultWidgetType;
// Returned when we do not know what impl to use
...
{
	static const std::string none = "none/none";
	return none;
}
