...
public:
	...
	// Overridden to return false for the Edit UI floater. HB
	LL_INLINE virtual bool canEditUI() const			{ return true; }
	...
	LL_INLINE bool getAutoFocus() const					{ return mAutoFocus; }
...
public:
	...
	bool bringToFront(LLFloater* floaterp, bool give_focus = true);
