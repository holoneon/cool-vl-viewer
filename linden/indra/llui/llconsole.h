...
private:
	// This method allows to replace text in the console, such as when we want
	// to replace an SLURL with the corresponding name of the resident, group,
	// experience, etc, after this name got fetched from the server... HB
	void replaceParaText(Paragraph* parap, const LLWString& search_text,
