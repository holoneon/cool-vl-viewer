...
public:
	...
	void setLabelUnselected(const std::string& label);
	void setLabelSelected(const std::string& label);
	void setLabel(const std::string& label);
	void setDisabledLabel(const std::string& label);
	void setDisabledSelectedLabel(const std::string& label);

	LL_INLINE void setDisabledLabelColor(const LLColor4& c)			{ mDisabledLabelColor = c; }

	LL_INLINE void setFont(const LLFontGL* fontp)
	{
