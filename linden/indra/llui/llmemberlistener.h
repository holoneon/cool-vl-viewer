...
//	}
//
//	T::LLDoTest::handleEvent(LLPointer<LLOldEvents::LLEvent> event,
//							 const LLSD& userdata)
//	{
//		T *self = mPtr;
//		...
...
public:
	...
	void registerListener(T* ptrp, const std::string& register_name)
	{
		mPtr = ptrp;
		mRegisteredName = register_name;
		ptrp->registerEventListener(register_name, this);
	}
