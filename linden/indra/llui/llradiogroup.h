...
public:
	...
	// You must use this method to add buttons to a radio group. Do not use
	// addChild() since it would not set the callback method correctly.
	LLRadioCtrl* addRadioButton(const std::string& name,
								const std::string& label,
								const LLRect& rect, const LLFontGL* fontp);
...
private:
	...
	// Updates the control as needed. 'userdata' *must* be a pointer to a
	// child button.
	static void onClickButton(LLUICtrl* radiop, void* userdata);
