...
public:
	...
	void setColorParameters(LLXMLNodePtr nodep);
	...
	// Use this if you want to disable the context menu (which is enabled by
	// default): needed by the inventory item renamer in LLFolderView. HB
	LL_INLINE void disableContextMenu()						{ mContextMenuEnabled = false; }
...
protected:
	...
	// Normally 'true', unless explicitely disabled with disableContextMenu()
