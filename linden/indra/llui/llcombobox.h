...
public:
	...
	// For simple items, this is just the the label.
	...
	LLScrollListItem* add(const std::string& name, const LLUUID& id,
						  EAddPosition pos = ADD_BOTTOM, bool enabled = true);
	LLScrollListItem* add(const std::string& name, void* userdatap,
						  EAddPosition pos = ADD_BOTTOM, bool enabled = true);
	...
	// Note: this must be the same typedef as for LLScrollListCtrl. HB
...
protected:
	static void onButtonDown(void* userdatap);
	static void onItemSelected(LLUICtrl* itemp, void* userdatap);
	static void onTextEntry(LLLineEditor* editorp, void* userdatap);
	static void onTextCommit(LLUICtrl* ctrlp, void* userdatap);
...
protected:
	static void onActionButtonClick(void* userdatap);
	static void onSelectAction(LLUICtrl* ctrl, void* userdatap);
