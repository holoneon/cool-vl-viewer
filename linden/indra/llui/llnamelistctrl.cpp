...
//virtual
const std::string& LLNameListCtrl::getTag() const
{
	return LL_NAME_LIST_CTRL_TAG;
}
									 ...
									 std::string& fullname)
{
	...
	LLAvatarNameCache::get(agent_id,
						   std::bind(&LLNameListCtrl::onAvatarNameCache, _1,
									 _2, this));
	return false;
}
...
bool LLNameListCtrl::getGroupName(const LLUUID& group_id, std::string& name)
{
	...
	gCacheNamep->get(group_id, true,
					 std::bind(&LLNameListCtrl::onGroupNameCache, _1, _2,
							   this));
	return false;
}
