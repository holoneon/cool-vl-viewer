...
LL_INLINE static int is_lcchar(const int c)
{
	return isalnum(c);
}
...
constexpr int num_primary_to_code = LL_ARRAY_SIZE(primary_to_code);
constexpr int num_both_to_code = LL_ARRAY_SIZE(both_to_code);
