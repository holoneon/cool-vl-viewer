...
{
	typedef std::map<std::string, U32, std::less<> > cur_map_t;
	static cur_map_t cursor_string_table;
	...
	cur_map_t::const_iterator iter = cursor_string_table.find(cursor_string);
