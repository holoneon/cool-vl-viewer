...
LLKeyboardWindows::LLKeyboardWindows()
{
...
//virtual
void LLKeyboardWindows::resetMaskKeys()
{
...
#if 0
void LLKeyboardWindows::setModifierKeyLevel(KEY key, bool new_state)
{
...
MASK LLKeyboardWindows::updateModifiers()
{
...
// other flags
//virtual
bool LLKeyboardWindows::handleKeyDown(U32 key, MASK mask)
{
...
// other flags
//virtual
bool LLKeyboardWindows::handleKeyUp(U32 key, MASK mask)
{
	U32 translated_mask = updateModifiers();
...
//virtual
MASK LLKeyboardWindows::currentMask(bool)
{
	MASK mask = MASK_NONE;
...
//virtual
void LLKeyboardWindows::scanKeyboard()
{
	MSG	msg;
...
bool LLKeyboardWindows::translateExtendedKey(U32 os_key, MASK mask,
											 KEY* translated_key,
...
U32 LLKeyboardWindows::inverseTranslateExtendedKey(KEY translated_key)
{
