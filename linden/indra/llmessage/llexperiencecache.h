...
public:
	typedef std::function<const std::string&(const char*)> cap_query_fn_t;
	...
	typedef std::function<void(const LLSD&)> experience_get_fn_t;
...
private:
	...
	typedef std::function<LLSD(LLCoreHttpUtil::HttpCoroutineAdapter::ptr_t& adapter,
