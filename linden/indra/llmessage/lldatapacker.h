...
public:
	...
	virtual bool packBinaryData(const U8* valuep, S32 size,
								const char* name) = 0;
	virtual bool unpackBinaryData(U8* valuep, S32 value_size, S32& size,
								  const char* name) = 0;

	// Constant size binary data packing
	virtual bool packBinaryDataFixed(const U8* valuep, S32 size,
									 const char* name) = 0;
	virtual bool unpackBinaryDataFixed(U8* valuep, S32 size,
									   const char* name) = 0;
...
public:
	...
	bool packBinaryData(const U8* valuep, S32 size, const char* name) override;
	bool unpackBinaryData(U8* valuep, S32 value_size, S32& size,
						  const char* name) override;

	// Constant size binary data packing
	bool packBinaryDataFixed(const U8* valuep, S32 size,
							 const char* name) override;
	bool unpackBinaryDataFixed(U8* valuep, S32 size,
							   const char* name) override;
