...
public:
	...
	LL_INLINE void setDNSCacheTimeout(S32 timeout)		{ mDNSCacheTimeout = timeout; }
	LL_INLINE S32 getDNSCacheTimeout() const			{ return mDNSCacheTimeout; }

	LL_INLINE void setLastModified(time_t modified)		{ mLastModified = modified; }
	LL_INLINE time_t getLastModified() const			{ return mLastModified; }
