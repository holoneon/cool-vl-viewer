...
static LLCoreInt::HttpMutex sStatMutex;

// Error testing and reporting for libcurl status codes
static void check_curl_multi_code(CURLMcode code, int curl_setopt_option)
{
	if (code != CURLM_OK)
	{
...
// This block used to be implemented in llcorehttpcommon.cpp, but since it
// deals with curl code, it is best implemented here. HB
namespace LLHttp
{
