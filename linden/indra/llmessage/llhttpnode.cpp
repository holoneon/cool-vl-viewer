...
{
public:
	typedef std::map<std::string, LLHTTPNode*, std::less<> > child_map_t;
...
LLSD LLHTTPNode::allNodePaths() const
{
	...
	Impl::child_map_t::const_iterator i = impl.mNamedChildren.begin();
	Impl::child_map_t::const_iterator end = impl.mNamedChildren.end();
	for ( ; i != end; ++i)
	{
