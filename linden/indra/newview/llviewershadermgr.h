...
public:
	...
	static bool					sCanRenderGLTFScene;
	// Set when PBR shaders are loaded, depending on GL capability. HB
	static bool					sCanDoRP;
	// Set when PBR shaders are loaded, depending on GL capability and
	// settings. HB
	static bool					sHasRP;
};
...
extern LLGLSLShader gHeroRadianceGenProgram;					// PBR only
...
extern LLGLSLShader gNormalDebugProgram[NORMAL_DEBUG_SHADER_COUNT]; // PBR only
extern LLGLSLShader gDebugProgram;
...
extern LLGLSLShader gHiZReduceProgram;							// PBR only
...
extern LLGLSLShader gDrawColorProgram;							// PBR only
...
// Post processing shader handles
...
extern LLGLSLShader gDeferredSunProbeProgram;					// PBR only
extern LLGLSLShader gHazeProgram;								// PBR only
extern LLGLSLShader gHazeWaterProgram;							// PBR only
extern LLGLSLShader gDeferredBlurLightProgram;					// EE/WL only
extern LLGLSLShader gSSRFilterProgram;							// PBR only
extern LLGLSLShader gDeferredAvatarProgram;
extern LLGLSLShader gDeferredSoftenProgram;
extern LLGLSLShader gDeferredSoftenCubeProgram;					// PBR only
...
extern LLGLSLShader gDeferredPostNoDoFNoiseProgram;				// PBR only
extern LLGLSLShader gDeferredPostGammaCorrectProgram;
extern LLGLSLShader gLegacyPostGammaCorrectProgram;				// PBR only
extern LLGLSLShader gDeferredPostTonemapProgram;				// PBR only
extern LLGLSLShader gNoPostTonemapProgram;						// PBR only
extern LLGLSLShader gExposureProgram;							// PBR only
extern LLGLSLShader gExposureProgramNoFade;						// PBR only
...
extern LLGLSLShader gEnvironmentMapProgram;						// PBR only
...
extern LLGLSLShader gScreenSpaceReflTraceProgram;				// PBR only
extern LLGLSLShader gSSRAlphaProgram;							// PBR only
extern LLGLSLShader gSkinnedSSRAlphaProgram;					// PBR only
extern LLGLSLShader gSSRWaterProgram;							// PBR only
...
extern LLGLSLShader gDeferredPBRTerrainProgram;					// PBR only
// Encodes detail level for dropping textures, in accordance with the glTF spec
// where possible. 0 is highest detail, -1 drops emissive, etc. Dropping
// metallic roughness is off-spec - Reserve for potato machines as needed.
...
// glTF shaders
extern LLGLSLShader gGLTFPBRMetallicRoughnessProgram;			// PBR only
