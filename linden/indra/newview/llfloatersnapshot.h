...
private:
	...
	static void updateResolution(LLUICtrl* ctrlp, void* datap,
								 bool do_update = false);

	static void onClickDiscard(void* datap);
	static void onClickKeep(void* datap);
	static void onCommitSave(LLUICtrl* ctrlp, void* datap);
	static void onClickNewSnapshot(void* datap);
	static void onClickAutoSnap(LLUICtrl* ctrlp, void* datap);
	static void onClickLess(void* datap);
	static void onClickMore(void* datap);
	static void onClickUICheck(LLUICtrl* ctrlp, void* datap);
	static void onClickHUDCheck(LLUICtrl* ctrlp, void* datap);
	static void onClickKeepAspectCheck(LLUICtrl* ctrlp, void* datap);
	static void onCommitQuality(LLUICtrl* ctrlp, void* datap);
	static void onCommitResolution(LLUICtrl* ctrlp, void* datap);
	static void onCommitFreezeFrame(LLUICtrl* ctrlp, void* datap);
	static void onCommitLayerTypes(LLUICtrl* ctrlp, void* datap);
	static void onCommitSnapshotType(LLUICtrl*, void* datap);
	static void onCommitSnapshotFormat(LLUICtrl*, void* datap);
	static void onCommitCustomResolution(LLUICtrl* ctrlp, void* datap);
