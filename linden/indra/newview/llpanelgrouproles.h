...
public:
	...
	static void* createTab(void* datap);
...
public:
	...
	// view hierarchy.
	virtual bool postBuildSubTab(LLView* rootp) 	{ return true; }

	static void onSearchKeystroke(LLLineEditor* caller, void* datap);
	...
	void buildActionsList(LLScrollListCtrl* ctrlp, U64 allowed_by_some,
						  U64 allowed_by_all, strings_map_t& icons,
						  void (*commit_callback)(LLUICtrl*, void*),
						  bool show_all, bool filter, bool is_owner_role);
	void buildActionCategory(LLScrollListCtrl* ctrlp, U64 allowed_by_some,
...
public:
	...
	bool postBuildSubTab(LLView* rootp) override;
	...
	static void onRoleCheck(LLUICtrl* checkp, void* datap);
	void handleRoleCheck(const LLUUID& role_id,
						 LLRoleMemberChangeType type);

	static void onBanMember(void* datap);
...
protected:
	...
	static void onBanEntrySelect(LLUICtrl*, void* datap);
	static void onCreateBanEntry(void* datap);
	static void onDeleteBanEntry(void* datap);
	static void onRefreshBanList(void* datap);
	static void onBanListMemberDoubleClick(void* datap);
