...
public:
	...
	void generateVisualParamHints(LLPanelEditWearable* panelp,
								  LLViewerJointMesh* joint_meshp,
								  param_map& params, LLWearable* wearablep,
								  bool use_hints, LLJoint* jointp);

	void updateScrollingPanelList(bool allow_modify);

	void setWearable(LLWearableType::EType type, LLViewerWearable* wearablep,
