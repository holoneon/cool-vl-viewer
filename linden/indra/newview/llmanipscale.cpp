...
F32 LLManipScale::maxPrimScale(bool is_flora)
{
	...
	return is_flora ? DEFAULT_MAX_PRIM_SCALE_NO_MESH : DEFAULT_MAX_PRIM_SCALE;
}
...
void LLManipScale::renderSnapGuides(const LLBBox& bbox)
{
...

	{
		...
		S32 num_ticks_per_side1 =
			llmax(1, 0.5f * mSnapGuideLength / smallest_subdivision1);
		S32 num_ticks_per_side2 =
			llmax(1, 0.5f * mSnapGuideLength / smallest_subdivision2);
		S32 ticks_from_scale_center_1 = S32(dist_scale_units_1);
		S32 ticks_from_scale_center_2 = S32(dist_scale_units_2);
