...
U8 LLToolPlacer::getTreeGrassSpecies(species_list_t& table,
									 const char* setting_name, U8 max)
{
	const std::string& species = gSavedSettings.getString(setting_name);
	species_list_t::iterator it;
