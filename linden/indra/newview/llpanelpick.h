...
protected:
	...
	static void onClickTeleport(void* datap);
	static void onClickMap(void* datap);
	static void onClickSetLocation(void* datap);

	static void onCommitAny(LLUICtrl*, void* datap);
