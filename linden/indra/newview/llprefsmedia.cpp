...
private:
	...
	static void* createVolumePanel(void*);

	static void onTabChanged(void* datap, bool from_click);

	static void onCommitCheckBoxFilter(LLUICtrl* ctrlp, void* datap);
	static void onCommitCheckBoxAudio(LLUICtrl* ctrlp, void* datap);
	static void onCommitCheckBoxMedia(LLUICtrl* ctrlp, void* datap);
	static void onCommitCheckBoxMediaHUD(LLUICtrl* ctrlp, void* datap);
	static void onCommitCheckBoxSharedMedia(LLUICtrl* ctrlp, void* datap);
	static void onCommitChecIncomingIMSession(LLUICtrl* ctrlp, void* datap);
...
//static
void* LLPrefsMediaImpl::createVolumePanel(void*)
{
	LLPanelAudioVolume* panelp = new LLPanelAudioVolume();
	return panelp;
}
...
void LLPrefsMediaImpl::refreshValues()
{
	...
	mMediaFilterMimeProbes = gSavedSettings.getBool("MediaFilterMimeProbes");
...
void LLPrefsMediaImpl::cancel()
{
	...
	gSavedSettings.setBool("MediaFilterMimeProbes", mMediaFilterMimeProbes);
...
//static
void LLPrefsMediaImpl::onTabChanged(void* datap, bool from_click)
{
	LLPrefsMediaImpl* self = (LLPrefsMediaImpl*)datap;
...
//static
void LLPrefsMediaImpl::onCommitCheckBoxMedia(LLUICtrl* ctrlp, void* datap)
{
	LLPrefsMediaImpl* self = (LLPrefsMediaImpl*)datap;
	LLCheckBoxCtrl* checkp = (LLCheckBoxCtrl*)ctrlp;
	if (!self || !checkp) return;
...
//static
void LLPrefsMediaImpl::onCommitCheckBoxMediaHUD(LLUICtrl* ctrlp, void* datap)
{
	LLPrefsMediaImpl* self = (LLPrefsMediaImpl*)datap;
	LLCheckBoxCtrl* checkp = (LLCheckBoxCtrl*)ctrlp;
	if (self && checkp)
...
//static
void LLPrefsMediaImpl::onCommitCheckBoxSharedMedia(LLUICtrl* ctrlp,
												   void* datap)
{
	LLPrefsMediaImpl* self = (LLPrefsMediaImpl*)datap;
	LLCheckBoxCtrl* checkp = (LLCheckBoxCtrl*)ctrlp;
...
//static
void LLPrefsMediaImpl::onCommitChecIncomingIMSession(LLUICtrl* ctrlp,
													 void* datap)
{
	LLPrefsMediaImpl* self = (LLPrefsMediaImpl*)datap;
	LLCheckBoxCtrl* checkp = (LLCheckBoxCtrl*)ctrlp;
...
//static
void LLPrefsMediaImpl::onCommitCheckBoxAudio(LLUICtrl* ctrlp, void* datap)
{
	LLPrefsMediaImpl* self = (LLPrefsMediaImpl*)datap;
	LLCheckBoxCtrl* checkp = (LLCheckBoxCtrl*)ctrlp;
	if (!self || !checkp) return;
	...
	self->childSetEnabled("notify_stream_changes",
						  self->mRunningFMOD && checkp->get());
}

//static
void LLPrefsMediaImpl::onCommitCheckBoxFilter(LLUICtrl* ctrlp, void* datap)
{
	LLPrefsMediaImpl* self = (LLPrefsMediaImpl*)datap;
	LLCheckBoxCtrl* checkp = (LLCheckBoxCtrl*)ctrlp;
	if (self && checkp)
	{
		bool enable = checkp->get();
		self->childSetEnabled("media_lookup_ip", enable);
		self->childSetEnabled("media_filter_mime_probes", enable);
	}
}
