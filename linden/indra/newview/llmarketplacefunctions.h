...
private:
	...
	typedef std::unique_ptr<status_updated_signal_t> status_sig_ptr_t;
	status_sig_ptr_t			mStatusUpdatedSignal;
	boost::signals2::connection	mStatusUpdatedSlot;
...
public:
	...
	typedef std::function<void(std::string& validation_message, S32 depth,
