...
public:
	...
	// Used by LLWorld::updateNetStats(). HB
	void addpPacketsStats(U32 in, U32 out, U32 lost, U32 dropped);
...
public:
	...
	// From the packet ring (when faking a bad connection)
	...
	U32		mPacketsInTotal;
	U32		mPacketsLostTotal;
	U32		mPacketsDroppedTotal;
