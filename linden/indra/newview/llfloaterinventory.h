...
public:
	...
	static void onTimeAgo(LLUICtrl*, void* datap);
	static void onResetFilters(void* datap);
	static void onCloseBtn(void* datap);
	static void selectAllTypes(void* datap);
	static void selectNoTypes(void* datap);
...
protected:
	static void onClearSearch(void* datap);
	static void onSearchEdit(const std::string& search_string, void* datap);
	static void onFilterSelected(void* datap, bool);
	static void onSelectionChange(LLFolderView* folderp, bool user_action,
								  void* datap);
	static void onCommitShowLinksInSearchCheck(LLUICtrl* ctrlp, void* datap);
	static void onCommitLockLastOpenCheck(LLUICtrl* ctrlp, void* datap);
