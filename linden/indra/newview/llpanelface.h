...
private:
	...
	LLPointer<LLViewerTexture>			mMatTexture;
	...
	bool				mHasMatNormal;
	bool				mHasMatSpecular;
	bool				mHasMatPBR;
	bool				mHasMultiplePbrSelection;
	bool				mIsAlpha;
