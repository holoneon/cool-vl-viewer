...
public:
	...
	static void processGroupNoticesListReply(LLMessageSystem* msg, void**);
...
private:
	static void onClickRemoveAttachment(void* datap);
	static void onClickOpenAttachment(void* datap);
	static void onClickSendMessage(void* datap);
	static void onClickNewMessage(void* datap);
	static void onClickRefreshNotices(void* datap);

	void processNotices(LLMessageSystem* msg);
	static void onSelectNotice(LLUICtrl*, void* datap);
