...
std::string LLLogChat::makeLogFileName(std::string filename)
{
	...
	filename = gDirUtil.getFullPath(LL_PATH_PER_ACCOUNT_CHAT_LOGS, filename);
	filename += ".txt";
	return filename;
}
							...
							void* userdata, const LLUUID& session_id)
{
	...
	// file. HB
	time_t last_modified = LLFile::lastModified(log_filename);
	...
	gCoros.launch("fetchHistoryCoro",
				  std::bind(&LLLogChat::fetchHistoryCoro, url, session_id,
