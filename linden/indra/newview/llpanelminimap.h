...
private:
	...
	class LLDrawLegend final : public LLMemberListener<LLPanelMiniMap>
	{
	public:
		bool handleEvent(LLPointer<LLOldEvents::LLEvent>,
						 const LLSD&) override;
	...
	class LLCheckDrawLegend final : public LLMemberListener<LLPanelMiniMap>
	{
	public:
		bool handleEvent(LLPointer<LLOldEvents::LLEvent>,
						 const LLSD& userdata) override;
...
private:
	...
	std::string					mLegendAvatar;
	std::string					mLegendFriend;
	std::string					mLegendPhysical;
	std::string					mLegendPathFinding;
	std::string					mLegendAnimesh;

	S32							mFriendLegendDeltaX;
