...
public:
	...
	LL_INLINE void setPixelArea(F32 area)
	{
		mPixelArea = area;
		// We need to recalculate the texture virtual size ASAP. HB
	...
	LL_INLINE LLViewerObject* getViewerObject() const	{ return mVObjp.get(); }
