...
public:
	...
	bool isDescendantOf(const LLFolderViewFolder* potential_ancestorp);
...
protected:
	static void commitRename(LLUICtrl*, void* datap);
	static void onRenamerLost(LLUICtrl* renamerp, void*);
...
public:
	...
	LL_INLINE U32 getSearchType()						{ return mFolders->getSearchType(); }
