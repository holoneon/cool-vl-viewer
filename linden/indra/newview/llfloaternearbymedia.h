...
private:
	...
	static void onClickSelectedMediaPlay(void* datap);
	static void onClickSelectedMediaPause(void* datap);
	static void onClickSelectedMediaStop(void* datap);
	static void onClickSelectedMediaMute(void* datap);
	static void onClickSelectedMediaUnmute(void* datap);
	static void onClickSelectedMediaZoom(void* datap);
	static void onClickSelectedMediaUnzoom(void*);
	static void onCheckItem(LLUICtrl* ctrl, void* datap);
	static void onCommitMediaType(LLUICtrl*, void* datap);
	static void onCommitMediaURL(LLUICtrl* ctrlp, void* datap);
	static void onSelectNewMedia(LLUICtrl* ctrlp, void* datap);
	static void onCommitSelectedMediaVolume(LLUICtrl*, void* datap);
