...
public:
	...
	// OpenSim min Z can go below 0. Always 0 in SL.
	LL_INLINE F32 getMinSimHeight() const					{ return mMinSimHeight; }
	...
	LL_INLINE S32 getMaxTextureSize() const					{ return mMaxTextureSize; }

	LL_INLINE bool hasPBRTerrain() const					{ return mHasPBRTerrain; }
	LL_INLINE bool hasPBRTerrainTransforms() const			{ return mHasPBRTerrainTransforms; }

	LL_INLINE bool isGLTFEnabled() const					{ return mGLTFEnabled; }

	LL_INLINE bool hasLuaCompileTarget() const				{ return mHasLuaCompileTarget; }

	LL_INLINE bool hasWebRTCVoice() const					{ return mHasWebRTCVoice; }
	LL_INLINE const std::string& getStunServers() const		{ return mStunServers; }
	...
	// Rebuilds the reflection probe list. When 'reload' is true, force a
	// reflection map re-registering. HB
	void updateReflectionProbes(bool reload = false);
...
private:
	...
	// CSV list of stun servers for WebRTC voice in this region (OpenSim only,
	// transmitted as a "stun-servers" simulator feature). HB
	std::string				mStunServers;
	...
	bool					mHasPBRTerrain;
	bool					mHasPBRTerrainTransforms;
	bool					mGLTFEnabled;
	bool					mHasLuaCompileTarget;
	bool					mHasWebRTCVoice;
...
public:
	...
	// Combat 2 system
	static U8			sOnDeath;
	static U32			sCombatFlags;
	static F32			sDamageThrottle;
	static F32			sRegenerationRate;
	static F32			sInvulnerabilityTime;
	static F32			sDamageLimit;
	static bool			sSupportsCombat2;
