...
const std::string EVENTS_URL("https://events.secondlife.com/viewer/embed/event/");
...
const std::string LSL_DOC_URL("https://wiki.secondlife.com/wiki/LSL_Portal");

const std::string RELEASE_NOTES_BASE_URL(
	"https://secondlife.com/app/releasenotes/");
...
void LLGridManager::loadGridsList()
{
	...
	loadGridsLLSD(mGridList,
				  gDirUtil.getFullPath(LL_PATH_APP_SETTINGS, "grids.xml"));
	mVerbose = false;
