...
void LLPrefsIMImpl::apply()
{
	...
	if (mGotPersonalInfo)
	{
		...
		gDirUtil.setChatLogsDir(gSavedPerAccountSettings.getString("InstantMessageLogPath"));

		gDirUtil.setPerAccountChatLogsDir(LLGridManager::getInstance()->getGridLabel(),
