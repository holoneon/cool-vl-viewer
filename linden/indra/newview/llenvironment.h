...
public:
	...
	public:
		...
		static ptr_t extract(const LLSD& env);
		static ptr_t extractLegacy(const LLSD& env);
	...
	typedef std::function<void(S32, envinfo_ptr_t)> env_apply_fn;
...
public:
	...
	static const LLUUID 		KNOWN_SKY_PBR_MIDDAY;
