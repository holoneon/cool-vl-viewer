...
public:
	...
	// Returns resolveLandHeightGlobal() in X and the region min height (which
	// can vary and be negative in OpenSim) in Y. HB
	LLVector2 resolveLandAndMinHeightGlobal(const LLVector3d& pos_global);
