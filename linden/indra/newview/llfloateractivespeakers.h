...
public:
	...
	const LLPointer<LLSpeaker> findSpeaker(const LLUUID& agent_id);
	...
	void requestMuteChange(const LLUUID& agent_id, bool mute);

protected:
	void updateSpeakerList();

	static void requestMuteChangeCB(const LLSD& result, std::string name,
...
public:
	LLIMSpeakerMgr(LLVoiceChannel* channelp);
...
public:
	LLPanelActiveSpeakers(LLSpeakerMgr* managerp, bool show_text_chatters);
	...
	static void onClickMuteVoice(void* userdatap);
	static void onClickDeviceSettings(void*);
	static void onClickMuteVoiceCommit(LLUICtrl* ctrlp, void* userdatap);
	static void onClickMuteTextCommit(LLUICtrl* ctrlp, void* userdatap);
	static void onVolumeChange(LLUICtrl* source, void* userdatap);
	static void onClickProfile(void* userdatap);
	static void onDoubleClickSpeaker(void* userdatap);
	static void onSelectSpeaker(LLUICtrl* source, void* userdatap);
	static void onSortChanged(void* userdatap);
	static void	onModeratorMuteVoice(LLUICtrl* ctrlp, void* userdatap);
	static void	onModeratorMuteText(LLUICtrl* ctrlp, void* userdatap);
	static void	onChangeModerationMode(LLUICtrl* ctrlp, void* userdatap);
...
protected:
	...
	LLSliderCtrl*						mSpeakerVolumeSlider;
