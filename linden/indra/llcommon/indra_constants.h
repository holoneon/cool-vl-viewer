...
// Not sent from keyboard. For internal use only.
constexpr KEY KEY_NONE		= 0xFF;

constexpr S32 KEY_COUNT		= 256;

constexpr F32 DEFAULT_WATER_HEIGHT = 20.f;
...
// New ScriptTeleportRequest flags for world map
