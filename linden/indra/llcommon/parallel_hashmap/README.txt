...
Plus, I slightly modified the files to:
 ...
 - provide a minor speed optimization with the PHMAP_DISABLE_MIX define (new in
   phmap v1.4.1) set to 1 in phmap.h (this replaces my custom PHMAP_NO_MIXING
   define in my pre-v1.4.1 patched code);
