...
namespace LLError
{
	...
	public:
		// When false, skip all LL_DEBUGS checks, for speed. HB
		static bool sDebugMessages;
		// When true, print milliseconds in timestamp for log messages. HB
		static bool sPreciseTimeStamp;
		// When true, abort() on llerrs instead of crashing. HB
