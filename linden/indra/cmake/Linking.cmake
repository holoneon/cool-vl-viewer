...
if (LINUX)
	# Under Linux we use the release pre-built libraries for the Release build
	# only, i.e. the debug libraries will be used for both Debug and
	...
	if (USEPREBUILTGLIB OR NOT USESYSTEMLIBS)
	...
	endif (USEPREBUILTGLIB OR NOT USESYSTEMLIBS)
	...
	if (PROTECTSTACK)
		...
		set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -Wl,--as-needed -Wl,-z,execstack")
