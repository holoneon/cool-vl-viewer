...
# NOTE: jemalloc cannot currently replace Microsoft Visual C++ runtime
# malloc(), and Linux aarch64 kernels got various possible page sizes, making
# it impossible to provide an universal pre-compiled library (see the comment
# at the end of this file). This setting is therefore only relevant to Linux
# x86_64 builds and will be automatically overridden to OFF for the rest.
set(USE_JEMALLOC ON)
...
# BEWARE: in spite of the authors' claims about its supposed performances,
# mimalloc causes a significant increase in memory usage by the viewer (up to
# +40% in low memory usage conditions, such as in a skybox), while not bringing
# any speed benefit when compared with jemalloc under Linux or the standard
...
# builds (for Linux, simply use the corresponding options in the linux-build.sh
# script, which will pass the appropriate boolean defines to cmake).
#set(USELTO ON)
#set(USEAVX ON)
#set(USEAVX2 ON)
