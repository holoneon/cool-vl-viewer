...
if (LINUX)
  if (USESYSTEMLIBS AND NOT USEPREBUILTSDL)
  ...
  endif (USESYSTEMLIBS AND NOT USEPREBUILTSDL)
...
if (LINUX)
  ...
  else (USESYSTEMLIBS AND NOT USEPREBUILTSDL)
...
# llwindowwindows.cpp and lldxhardware.cpp use COMDLG32, IMM32, WMI and DXGI.
if (WINDOWS)
