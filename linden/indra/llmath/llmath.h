...
#include "hbintrinsics.h"	// Includes appropriate intrinsics headers. HB
...
// std::lerp got introduced with C++20 and conflicts with our custom lerp(), so
// just use the former with C++20 and newer. HB
