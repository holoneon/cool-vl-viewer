...
public:
	...
	LL_INLINE explicit LLMatrix4a(const F32* val)
	{
		loadu(val);
	}
	...
	LL_INLINE LLMatrix4& asMatrix4()
	{
		return *(LLMatrix4*)this;
	}

	LL_INLINE const LLMatrix4& asMatrix4() const
	{
		return *(LLMatrix4*)this;
	}

	LL_INLINE bool operator==(const LLMatrix4a& rhs) const
	{
		return mMatrix[0] == rhs.mMatrix[0] && mMatrix[1] == rhs.mMatrix[1] &&
			   mMatrix[2] == rhs.mMatrix[2] && mMatrix[3] == rhs.mMatrix[3];
	}
