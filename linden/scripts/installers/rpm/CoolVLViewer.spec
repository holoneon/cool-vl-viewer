...
%{?_with_gcc14:	%{expand: %%global opt_compiler -v14}}
%{?_with_gcc13:	%{expand: %%global opt_compiler -v13}}
%{?_with_gcc12:	%{expand: %%global opt_compiler -v12}}
%{?_with_gcc11:	%{expand: %%global opt_compiler -v11}}
%{?_with_gcc10:	%{expand: %%global opt_compiler -v10}}
%{?_with_gcc9:	%{expand: %%global opt_compiler -v9}}
%{?_with_gcc8:	%{expand: %%global opt_compiler -v8}}
